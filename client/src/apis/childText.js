...
export const childText = [
    ...
    "continue with 30 compressions and two breath cycles.Do not Stop CPR until you can feel a pulse without compression. Its imperative to minimize time between breaths and compressions.Did the babies pulse return?"

]

export const childAnswers = [
    '',
    'Yes',
    'Check your surroundings. Is the scene safe?',
    '',
